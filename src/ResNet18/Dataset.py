...
class CelebA(torch.utils.data.Dataset):
    ...
    def __getitem__(self, i):
        ...
        # 选人的图片
        anchor_path = self.root / random.choice(anchor_person)         # 在第 i 个人中随机选取一张人脸作为锚点
        positive_path = self.root / random.choice(anchor_person)       # 在第 i 个人中随机选取一张人脸作为正例
        negative_path = self.root / random.choice(negative_person)     # 在另一个人（非第 i 个人）中随机选取一张人脸作为反例
